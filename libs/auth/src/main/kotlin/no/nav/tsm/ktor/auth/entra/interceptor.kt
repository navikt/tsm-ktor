...
/**
 * Enables both entra machine token and entra on-behalf-of token. Use call.onBehalfOfUserMaybe() to retrieve
 * the user principal if present, or null if the request was authenticated with a machine token.
 */
